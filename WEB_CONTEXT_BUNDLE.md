...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-cea881179a9e7e75"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-cea881179a9e7e75",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-cea881179a9e7e75",
        "url": "https://en.wikipedia.org/wiki/Erd%C5%91s%E2%80%93Straus_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Erdős–Straus conjecture : for every $n\\geq 2$ , there are positive integers $x,y,z$ such that $4/n=1/x+1/y+1/z$ .",
      "version": 1
    },
    "title": "Erdős–Straus conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "eda23eb53e1f2bbce795ee35206cffe42ffe9e8940a2e03338aa406e63bfc736"
}
```
